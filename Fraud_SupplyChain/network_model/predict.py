## Model Evaluation and Prediction for Network-based Model
...
def evaluate_model(model, X_test, y_test, config):
    ...
    """
    print("\n" + "="*60)
    print("Evaluating Network-based Model...")
    print("="*60)
    ...
    with open(metrics_file, 'w') as f:
        f.write("="*60 + "\n")
        f.write("NETWORK-BASED MODEL EVALUATION RESULTS\n")
        f.write("="*60 + "\n\n")
...
def plot_confusion_matrix(cm, config):
    ...
    plt.title('Confusion Matrix - Network-based Model')
    plt.ylabel('Actual')
