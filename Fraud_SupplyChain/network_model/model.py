## Define the Deep Neural Network model for Network-based Fraud Detection
...
def build_model(input_dim):
    """
    Build a Deep Neural Network for fraud detection using network features
    
    Args:
        input_dim: Number of input features (4 network centrality measures)
    
    Returns:
        Compiled Keras Sequential model
    """
    clf = Sequential(name='Network_Model')
